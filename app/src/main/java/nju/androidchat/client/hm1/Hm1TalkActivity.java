...
@Log
public class Hm1TalkActivity extends AppCompatActivity implements Hm1Contract.View, TextView.OnEditorActionListener, OnRecallMessageRequested {
    private Hm1Contract.Presenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Hm1TalkModel hm1TalkModel = new Hm1TalkModel();

        // Create the presenter
        this.presenter = new Hm1TalkPresenter(hm1TalkModel, this, new ArrayList<>());
        hm1TalkModel.setIMvp0TalkPresenter(this.presenter);
    }
    ...
    @Override
    public void setPresenter(Hm1Contract.Presenter presenter) {
